...
# Scatter principal
plt.scatter(OmegaCen_df['pmRA'], OmegaCen_df['pmDE'], color='k', alpha=0.5, s=2, label = 'GDR3 stars')
...
axins.scatter(OmegaCen_df['pmRA'], OmegaCen_df['pmDE'], color='k', alpha=0.5, s=2)
...
plt.close()
#plt.show()
print('----------------\nEn base al gráfico y los resultados de Baumgardt et al. (2019) y Vasiliev & Baumgardt (2021) se procede a \nseleccionar las estrellas que estén dentro del circulo centrado en  pmRA = -3.250 y pmDE = -6.746, de radio 2.0')
